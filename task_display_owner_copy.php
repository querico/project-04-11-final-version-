...
$taskDetails = $myTaskObj->displayTaskInfo(21); //taskID
$taskName = $taskDetails[0]['TaskName'];
$taskDis = $taskDetails[0]['TaskDescription'];
$taskDur =  $taskDetails[0]['Duration'];
$taskEST =  $taskDetails[0]['CreateDate'];
$taskETA =  $taskDetails[0]['ETA'];
$task_priority ="";
$task_status ="";
$taskParent = $taskDetails[0]['parentName'];
switch ($taskDetails[0]['Priority']) {
			case 1:  
...
$complted = $myTaskObj-> displayCompletedLevel(21);
...
<!--********script and CSS links at CPIT***********-->
			...
			<div class="panel-body">
				...
				<table id = "taskInfo" class="table table-bordered table-striped" style="clear:both">
						...
						<tr>
							...
							<td width="80%"> <?php  print ($taskName); ?></td>
						</tr>

						<tr>
							<td width="20%"><b>Task Decription ::</b></td>
							<td width="80%"><?php  print($taskDis); ?></td>
						</tr>

						<tr>
							<td width="20%"><b>Task Duration(Hrs) ::</b></td>
							<td width="80%"><?php  print($taskDur) ?></td>
						</tr>

						<tr>
							<td width="20%"><b>Task ETA ::</b></td>
							<td width="80%"><?php print($taskETA); ?></td>
						</tr>

						<tr>
							<td width="20%"><b>Task Status ::</b></td>
							<td width="80%"><?php print($task_status); ?></td>
						</tr>

						<tr>
							<td width="20%"><b>Task Priority ::</b></td>
							<td width="80%"><?php print($task_priority); ?></td>
						</tr>

						<tr>
							<td width="20%"><b>Parent Task::</b></td>
							<td width="80%"><?php print($taskParent); ?></td>
						</tr>
				</table>
	...
	<div class="col-sm-3">
		<div class="panel panel-back-3">
			...
			<form action="./api/task/add_sub_task" method="post" class="ajax" name="taskform">
...
** -->
	...
	<script type = "text/javascript" src = "./Javascript/jquery.simple-dtpicker.js"></script>
	<script type = "text/javascript" src = "./Javascript/task_managment.js"></script>
	<script type = "text/javascript" src = "./Javascript/bootstrap-editable.js"></script>
